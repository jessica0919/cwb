getweather=function(FILE,LABEL) {
  title=c("芠代丁","代溃","溃", "代程蔼溃",
          ...
          "臩翴放","癸访", "程癸访","程癸访丁","硉",
          "", "程皚","程皚","程皚硉丁", "秖",
          "计","芠代10だ牧程秖", "芠代10だ牧程癬﹍丁",
          "程秖", "程秖癬﹍丁","ら酚计",
          "ら酚瞯", "ぱら甮秖","ǎ","A籡祇秖")
...
plot(aug$代溃,type="b", pch=16, col="black",las=1,xlab="ら戳" ,
     ylab="溃",main="2017/08", axes=TRUE)
plot(sep$代溃,type="b", pch=16, col="black",las=1,xlab="ら戳" ,
     ylab="溃",main="2017/09", axes=TRUE)
plot(oct$代溃,type="b", pch=16, col="black",las=1,xlab="ら戳" ,
     ylab="溃",main="2017/10", axes=TRUE)
